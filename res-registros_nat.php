...
$sql = "SELECT nombre, telefono, correo, cedula FROM reg_pers_naturales WHERE cedula='$CED';
";
...
"<div class='flotante'> ","<h2>" ,"nombre ♠ " ,$row["nombre"],"<br>", "telefono ♠ ",$row["telefono"],"<br>", "correo ♠ ",$row["correo"],"<br>", "cedula ♠", $row["cedula"], "</h2>","</div>","</div>", "<br>","<br>","<br>","<br>","<br>","<br>","<br>","<br>","<br>","<hr>";
...
$result = mysqli_query($conexion, $sql);
 ...
 "<div class='card'>",
 "<form action='borrar-n.php' class='card-body' method='GET' >  ",
...
<div class="form-group">
<button type="button" id="add" class="btn btn-secondary"  ondblclick="document.getElementById('1').style.display='block' "  >  <a href="FormAgregar-n.php" style="color:white"> Nuevo Registro</a> </button>
</div>
</form>
</div>
</div>
...
<div id="1" style="display:none" class="container ">
  ...
  <div class="col-lg-auto">
   ...
   <h3 >Actualizar datos: Naturales</h3>
   </div>
   <form action="actualizar-n.php" class="card-body" method="GET">
